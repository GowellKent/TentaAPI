        ...
        <div class="card-body">
            <form action="/admin/transportasi/create" method="post">
                ...
                <div class="form-floating my-3">
                    <input type="text" name="tt_kode" class="form-control" readonly value="AUTO" id="floatingtt_kode">
                ...
                <div class="input-group">
                    ...
                    <div class="form-floating">
                        <input type="number" name="tt_harga" class="form-control" id="floatingtt_harga" step="1000"
                            value="{{ old('tt_harga') }}">
