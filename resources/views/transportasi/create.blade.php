        ...
        <div class="card mx-auto mt-5" style="width: 40rem;">
            <div class="card-body">
                <form action="/admin/transportasi/create" method="post">
                    ...
                    <div class="form-floating my-3">
                        <input type="number" name="tt_pax" class="form-control" id="floatingtt_pax" value="{{old('tt_pax')}}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-floating">
                            <input type="number" name="tt_harga" class="form-control" id="floatingtt_harga" step="1000" value="{{old('tt_harga')}}">
